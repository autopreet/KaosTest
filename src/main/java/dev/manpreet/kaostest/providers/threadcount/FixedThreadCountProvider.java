...
/**
 * Implementation for the thread count provider to set the number of test runner threads. This basic implementation takes a fixed
 * number and provides the same to the test runner. The runner will continue the run the tests in the provided number of threads
